...
import { Breadcrumb, Spin, Modal, Divider } from 'antd';
...
const EducationPage = (props) => {
    ...
    const [isNonMemberModalShow, setIsNonMemberModalShow] = useState(false);
    ...
    const loadPagination = () => {
        ...
        services.loadPagination(paginationPayload)
        .then(res => {
            var r = res.data;
    ...
    return (
        <section className="section" id="home">
            <div className="container-fluid mt-3 pr-0 pl-0">
                <div className="container mb-3">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item>Modul Pembelajaran</Breadcrumb.Item>
                    </Breadcrumb>
                </div>
            </div>
            ...
            <div className="container mt-2">
                ...
                <Modal
                    style={{ top: 20 }}
                    visible={isNonMemberModalShow}
                    // visible={true}
                    onCancel={() => setIsNonMemberModalShow(false)}
                    centered
                    footer={null}>
                ...
                <Row className="">
                    ...
                    <Col md="12" lg="9" className="mb-3">
                        <h6 className="fw-700 mb-3">
                            <span className='mr-3 sub-menu sub-menu-active'>Modul</span> <span className='sub-menu'><a href="/edukasi/webinar-recording">Recording</a></span>
                        </h6>

                        <Spin indicator={antIcon} spinning={loading.isPaginationLoading}>
                            <Grid listData={fields} setShow={setIsNonMemberModalShow} loading={loading.isPaginationLoading} />
                        </Spin>
                        {!isFullyLoaded && 
                            <Row>
